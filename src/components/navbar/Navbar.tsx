...
export default function Navbar() {
  return (
    <nav className="bg-[#454B52] flex items-center h-24 w-screen border-[#9A9996] border-b-2 md:flex-nowrap flex-wrap justify-center">
      <p className="lg:text-2xl sm:text-xl font-medium lg:w-1/3 w-full justify-center md:flex hidden lg:mr-0 ml-6">
        echo "
      ...
      <div className="lg:text-xl sm:text-md lg:gap-6 gap-2 flex flex-row lg:mr-10 lg:w-1/3 lg:ml-0 mdml-5 justify-end">
        <FaDiscord className="lg:mt-1 lg:size-5 mt-2 size-3 text-[#33ECD5] md:flex hidden" />
        <Link
        ...
        <FaFacebookSquare className="lg:mt-1 lg:size-5 mt-2 size-3 text-[#33ECD5] md:flex hidden" />
        <Link
        ...
        <AiFillInstagram className="lg:mt-1 lg:size-5 mt-2 size-3 text-[#33ECD5] md:flex hidden" />
        <Link
        ...
        <FaYoutube className="lg:mt-1 lg:size-5 mt-2 size-3 text-[#33ECD5] md:file: hidden" />
        <Link
